...
$(document).ready(function () {
  ...
  const tetherusd = "HIVsRcGKkPFtW"
  const binancecoin ="WcwrkfNI4FUAe"
  ...
  function getCoinData(currency, timeframe) {
      ...
      var apiKey = "coinranking97dd0079db2ec447bc4af83adc4c2d94efc925f76570c087"
  ...
  $('#cryptoList').change(function () {
      ...
      switch (selectedValueCurrency) {
          ...
          case 3:
               console.log("radio Teather success");
               uuid = tetherusd;
               getCoinData(uuid, time);
               break;

          case 4:
               console.log("radio binancecoin success");
               uuid = binancecoin;
               getCoinData(uuid, time);
               break;
